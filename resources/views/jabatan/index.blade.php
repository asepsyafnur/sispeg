    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('jabatan.store') }}" method="POST" id="add-form">
                        @csrf
                        <div class="form-group">
                            <input type="text" name="nama" class="form-control" value="{{ old('nama') }}" id="nama" placeholder="Masukkan nama jabatan">
...
<script>
    ...
    $(document).on('click', '#btnEdit', function(){
        ...
        $.post("{{ route('jabatan.edit') }}", {id:id}, function(data){
